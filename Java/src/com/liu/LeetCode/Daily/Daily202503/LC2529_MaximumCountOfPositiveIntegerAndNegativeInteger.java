...
public class LC2529_MaximumCountOfPositiveIntegerAndNegativeInteger {
    ...
    // 边界处理是很重要的
    private static int maximumCountMy1(int[] nums) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numsList.length; i++) {
            ...
            result = maximumCountMy1(numsList[i]);
            endTime = System.currentTimeMillis();
            System.out.println("maximumCount My1 result" + i + " " + result + " during time " + (endTime - startTime));
        }
    }
}
