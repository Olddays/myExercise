 ...
 */
public class LC534_DesignTinyURL {
    /**
    ...
    public static String encodeMy1(String longUrl) {
        return "";
    }

    // Decodes a shortened URL to its original URL.
    public static String decodeMy1(String shortUrl) {
        return "";
    }

    // Encodes a URL to a shortened URL.
    public static String encodeAnswer1(String longUrl) {
        return "";
    }

    // Decodes a shortened URL to its original URL.
    public static String decodeAnswer1(String shortUrl) {
        return "";
    }
